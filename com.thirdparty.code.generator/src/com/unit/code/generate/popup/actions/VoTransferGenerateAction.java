...
import com.unit.code.generate.wizard.VoTransferGenerateWizard;

public class VoTransferGenerateAction implements IObjectActionDelegate {
	...
	public void run( IAction arg0 ) {
		VoTransferGenerateWizard wizard = new VoTransferGenerateWizard( selection );
